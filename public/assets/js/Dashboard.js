        ...
        products.forEach(product => {
            ...
            table.innerHTML += `
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-4 px-6"><span class=" ${statusColor} px-3 py-1 rounded-full">in stock</span></td>
                    <td class="py-4 px-6 flex gap-2"><span class="icon-[material-symbols--delete-outline] text-red-500 text-2xl"></span>
